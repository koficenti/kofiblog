...
export default function Article(){
    ...
    return s.articleOpened && article ? <div id="article_reader" className={`z-10 px-20 pt-10 absolute top-[100px] left-0 bg-custom-black w-full overflow-hidden`}>
        ...
        <div className="w-full min-h-[300px] bg-custom-gray mb-5 rounded-md overflow-hidden relative">{image(article)}</div>
